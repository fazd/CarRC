...
def draw_circle(img, contour,maximo):
...
"""
image = cv2.imread('Stop_data/1.jpg')
img, img_bw = preliminar_image(image,"prel")
bc, mask = find_biggest_contour(img_bw)
draw_square(image,bc)
"""